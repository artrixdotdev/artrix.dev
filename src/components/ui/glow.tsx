   ...
   return (
      <div ref={element} className={cn(className, "relative")}>
         <div
            ...
            className={cn(
               className,
               "absolute pointer-events-none opacity-15 inset-0 dark:mix-blend-lighten mix-blend-multiply after:content-[''] after:absolute after:bg-background/90 after:inset-0.25 after:rounded-[inherit]",
            )}
         ></div>
         {children}
      </div>
